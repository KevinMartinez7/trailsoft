...
export interface ContactPayload extends AttributionData { name: string; company: string; email: string; phone: string; projectType: string; message: string; website: string; }
